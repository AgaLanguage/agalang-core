...
impl From<u8> for OpCode {
  fn from(value: u8) -> Self {
    match value {
      ...
      x if x == Self::Exponential as u8 => Self::Exponential,
      x if x == Self::Nullish as u8 => Self::Nullish,
      x if x == Self::Negate as u8 => Self::Negate,
      x if x == Self::Not as u8 => Self::Not,
      x if x == Self::ToBoolean as u8 => Self::ToBoolean,
      x if x == Self::ToString as u8 => Self::ToString,
